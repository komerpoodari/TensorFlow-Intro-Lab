# This repository baseline is from Udacity Self Driving Nano Degree Program.
My additions are related to assignment completion that include min-max normalization, weights and biases initialization and playing with hyper parameters.
